{
  ...
  outputs =
    ...
    in
    {
      ...
      #        };
      #        bindMounts."/primal" = {
      #          hostPath = "/mnt/ciberia/nostr_hub/primal";
      #          isReadOnly = false;
      #        };
      ...
      #          # Script para instalar e rodar o Node.js app
      #          systemd.services.primal = {
      #            wantedBy = [ "multi-user.target" ];
      #            description = "Primal's web app for Nostr";
      #            enable = true;
      #            serviceConfig = {
      #              WorkingDirectory = "/primal";
      #              ExecStartPre = ''
      #                ${pkgs.coreutils}/bin/cp -rT ${primal} //primal
      #              '';
      #              ExecStart = ''
      #                ${pkgs.nodejs_22}/bin/npm run dev:host
      #              '';
      #            };
      #          };
